...
class ControlSuiteShell(cmd.Cmd):
    ...
    def __init__(self):
        ...
        self.joint_ctrl_client = actionlib.SimpleActionClient('/ns1/kimm_action_manager/joint_posture_control', kimm_action_manager.msg.JointPostureAction)
        self.joint_ctrl_client.wait_for_server()
        self.se3_ctrl_client = actionlib.SimpleActionClient('/ns1/kimm_action_manager/se3_control', kimm_action_manager.msg.SE3Action)
        self.se3_ctrl_client.wait_for_server()
        self.se3_array_ctrl_client = actionlib.SimpleActionClient('/ns1/kimm_action_manager/se3_array_control', kimm_action_manager.msg.SE3ArrayAction)
        self.se3_array_ctrl_client.wait_for_server()
        self.gripper_ctrl_client = actionlib.SimpleActionClient('/ns1/kimm_action_manager/gripper_control', kimm_action_manager.msg.GripperAction)
        self.gripper_ctrl_client.wait_for_server()
        self.move_ctrl_client = actionlib.SimpleActionClient('/ns1/kimm_action_manager/move_control', kimm_action_manager.msg.MoveAction)
        self.move_ctrl_client.wait_for_server()

        self.gravity_pub = rospy.Publisher('/ns1/kimm_action_manager/gravity_ctrl', Bool, queue_size=1)
        self.gravity = True
